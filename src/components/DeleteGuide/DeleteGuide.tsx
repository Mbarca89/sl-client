...
const DeleteGuide: React.FC<DeleteGuideProps> = ({ id, updateList }) => {
    ...
    const handleDelete = async () => {
        setloading(true)
        try {
            const res = await axiosWithToken.delete(`${SERVER_URL}/api/guides/delete?id=${id}`)
            if (res.data) {
    ...
    return (
        <div className="d-flex flex-column align-items-center">
            <span>¿Esta seguro que quiere eliminar la guia?</span>
